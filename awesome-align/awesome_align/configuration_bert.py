...
BERT_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    ...
    "microsoft/codebert-base": "https://huggingface.co/microsoft/codebert-base/resolve/main/config.json",
}
...
class BertConfig(PretrainedConfig):
    r"""
        ...
        Args:
            ...
            position_embedding_type (:obj:`str`, optional, defaults to "absolute"):
